 ...
 *
 * Vendored rather than pulled from a CDN on purpose: an order page can carry
 * a customer's name and home address, and there is no reason for a third
 * party to be asked for a script while that is on screen.
 */
